...
class DiscordBots extends events.EventEmitter
{
  ...
  update()
  {
    if (Array.isArray(this.settings.websites) && client && client.user)
    {
  ...
  request(website, settings)
  {
    return new Promise((resolve, reject) =>
    {
      ...
      let botID = website.id || (module.exports.settings.websites[website] || {}).id || client.user.id;
      let sc = website.server_count || (module.exports.settings.websites[website] || {}).server_count || Array.from(client.guilds).length;
